...
const PersonalInformation = ({
  ...
  const profilePics = adminProfile?.profilePics
  ...
  const formik = useFormik({
    initialValues: {
      ...
      gender: adminProfile?.profilePics ?? 'MALE',
    },
    onSubmit: async (values: IUpdateAdminProfile) => {
      ...
      const credentials = {
        ...
        profilePics: dp[0]?.data?.secure_url,
      }
  ...
  const uploadSingleImage = (file, type) => {
    ...
    formData.append('upload_preset', 'admin_folder')
  ...
  useEffect(() => {
    if (profile) {
      setFieldValue('firstName', adminProfile.firstName)
      setFieldValue('lastName', adminProfile.lastName)
      setFieldValue('gender', adminProfile.gender)
    }
  }, [adminProfile, profile, setFieldValue])
      ...
      <div className={styles.formContainer}>
        ...
        >
          ...
          <Button
            ...
            isLoading={isUpdatingAdminProfile || isUploadingFile}
          >
            Edit profile
          </Button>
        </form>
