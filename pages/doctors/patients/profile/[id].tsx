...
import no_profile from 'public/images/no-profile.svg'
  ...
  return (
    <>
      ...
      <div className={stylelo.card}>
        <BlankCardLarge bdr="16px" hg="916px" aofy={true}>
          ...
          <div className={stylelor.mainWrapper}>
            <div className={`${stylelor.wrapper} ${stylelor.rightBorder}`}>
              <div className={stylelor.whead}>
                <Avatar
                  src={no_profile}
                  sx={{ width: 144, height: 144 }}
                  alt="profile image"
                />
                <div>{data.head.name}</div>
                <br />
              </div>
              <hr className={stylelor.hr} />
              <div className={stylelor.basic}>
                <div>Basic Information</div>
                <div>
                  <div className={stylelor.flexSpace}>
                    <div>Gender</div>
                    <div>{data.basic.gender}</div>
                  </div>
                  <div className={stylelor.flexSpace}>
                    <div>Age</div>
                    <div>{data.basic.age}</div>
                  </div>
                </div>
              </div>
              <div className={stylelor.basic}>
                ...
                <div>
                  <div className={stylelor.flexSpace}>
                    <div>Genotype</div>
                    <div>{data.details.genotype}</div>
                  </div>
                  <div className={stylelor.flexSpace}>
                    <div>Blood Type</div>
                    <div>{data.details.bloodType}</div>
                  </div>
                </div>
              </div>
              <div className={stylelor.basic}>
                ...
                <div>
                  <div className={stylelor.flexSpace}>
                    <div>
                      Weight <span className={stylelor.unit}>(kg)</span>
                    </div>
                    <div>{data.measurements.weight}</div>
                  </div>
                  <div className={stylelor.flexSpace}>
                    <div>
                      Height <span className={stylelor.unit}>(cm)</span>
                    </div>
                    <div>{data.measurements.height}</div>
                  </div>
                  <div className={stylelor.flexSpace}>
                    <div>
                      Chest <span className={stylelor.unit}>(cm)</span>
                    </div>
                    <div>{data.measurements.chest}</div>
                  </div>
                  <div className={stylelor.flexSpace}>
                    <div>
                      Waist <span className={stylelor.unit}>(cm)</span>
                    </div>
                    <div>{data.measurements.waist}</div>
                  </div>
                </div>
              </div>
            </div>
