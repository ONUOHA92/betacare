...
import RequestLabCard from 'containers/RequestLabCard'
import RequestTestCard from 'containers/RequestTestCard'
import Button from '@mui/material/Button'
import Paper from 'components/Paper'

const LaboratoryRequestCard = dynamic(
  () => import('containers/LaboratoryRequestCard'),
  { ssr: false }
)

const LaboratoryRequestCardAmb = dynamic(
  () => import('containers/LaboratoryRequestCardAmb'),
  { ssr: false }
)
const Laboratory = () => {
  const data = [
