  ...
  return (
    <div className={styles.rightCards1}>
      ...
      {singleBtn ? (
        ...
        <div className={styles.presBtnns}>
          <Button className={styles.presBtn1} onClick={() => setAmbulance()}>
            Request Now
          </Button>
          <Button className={styles.presBtn2}>Schedule Late</Button>
        </div>
      )}
    </div>
  )
