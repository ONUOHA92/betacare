...
import { OPERATION_ILLNESS_TYPE } from 'constants/constants'
...
const Illness = ({
  ...
  const savedData = getIllnessBasedOnType(illness, OPERATION_ILLNESS_TYPE)
  ...
  const formik = useFormik({
    ...
    onSubmit: (values: IProfileIllness) => {
      const newCredentials: any = {
        illnessType: OPERATION_ILLNESS_TYPE,
    ...
    <>
      ...
      >
        ...
        >
          ...
          <br />
          <div className={styles.gapSmall}>Date of operation</div>
